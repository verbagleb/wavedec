...
int readGrid(const char * grid_name, int &subW, int &subH, 
		char ** &images_array, int &images_number, double * &qf_array, int &qf_number);
...
int formOutput(char * output_dir_name, const char * bitmap_name, double quantFactor, int totalBands, FILE ** log_this);
